    ...
    <main>
        ...
        <div class="home-block home-block-pre" id="presentation">
            ...
            <div class="home-block-pre-row row2">
                ...
                <div class="pre-block pre-block2">
                    ...
                    <p>Tu pourras vivre des relations basées sur le respect. Tu découvriras la culture hip-hop et pourras partager autour de thématiques telle que
        ...
        <div class="home-block home-block-va" id="values">
            ...
            <div class="home-block-va-row row6">
                ...
                <div class="value-content">
                    <h3>Éducation</h3>
                    <p>L’histoire de la culture hip-hop est partagée et des thématiques tel que le racisme, la mixité sociale, la violence sont abordées. </p>
                </div>
            </div>
        </div>
            ...
            <div class="home-block-co-row row2">
                ...
                <div class="comity-presentation" id="0">
                    ...
                    <div class="comity-presentation-text">
                        ...
                        <p class="comity-description"> Isa travaille en tant que collaboratrice jeunesse pour l’Armée du Salut.
                            Elle s’est formée en tant qu’enseignante à la HEP-BEJUNE et a exercé pendant 2 ans avant d’accepter
                            la place qu’elle occupe actuellement. La pédagogie et la transmission aux plus jeunes sont donc des éléments essentiels
                            dans sa pratique de tous les jours. Isa a commencé la danse d’abord dans le cadre familial et lors de camps. Elle s’est
                            ensuite formée dans diverses écoles de danse. Elle a formé un crew en 2018, avec lequel elle a participé à plusieurs championnats suisses.
        ...
        <div class="home-block home-block-sup" id="support">
            ...
            <div class="home-block-sup-row row2">
                ...
                <div class="sup-block sup-block2">
                    <h3>Sponsoring</h3>
                    <p>Différentes offres sont possibles pour le sponsoring, téléchargez notre dossier de sponsoring pour plus d’informations.</p>
                </div>
